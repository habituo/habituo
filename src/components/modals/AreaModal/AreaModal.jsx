...
/**
 * Custom hook to manage the state and logic for the Area creation/editing form.
 * @param {object | null} selectedArea - The area object to edit, or null for creation.
 */
const useAreaForm = (selectedArea) => {
  ...
  /**
   * Effect to populate the form fields when selectedArea changes (i.e., when editing).
   * It also clears the form when selectedArea is null (i.e., when opening for creation).
   */
  useEffect(() => {
    if (selectedArea) {
...
AreaModal.propTypes = {
  ...
  /** Callback function to close the modal. It accepts an optional boolean to indicate successful save. */
  onClose: PropTypes.func.isRequired,
  /** The area object currently being edited, or null if creating a new area. */
