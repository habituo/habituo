  ...
  return (
    <Box as="label">
      ...
      <HStack
        ...
        spacing={2}
        userSelect="none"
        _hover={{borderColor: `${props.value}.500`}}
        _checked={{
...
const CustomThemePanel = () => {
  ...
  const defaultFocusColor = "orange";
  ...
  const handleThemeChange = useCallback(
    (key, value) => {
      const newSettings = {
        focusColor: key === "focusColor" ? value : themeOptions.focusColor,
        fontFamily: key === "fontFamily" ? value : themeOptions.fontFamily,
        borderRadius:
          key === "borderRadius" ? value : themeOptions.borderRadius,
      };
  ...
  return (
    <>
      <Button
        ...
        _focusVisible={{}}
      >
        <Text isTruncated>Crea tu estilo</Text>
      </Button>
      ...
      <Drawer placement="left" onClose={onClose} isOpen={isOpen}>
        ...
        >
          <DrawerCloseButton _focusVisible={{}} />
          ...
          <DrawerBody p={4}>
            ...
            <FormControl>
              <FormLabel fontSize="sm">Bordes</FormLabel>
              <Slider
